...
export default function NRI1502() {
  ...
  useEffect(() => {
    const collectionName = "dom-english-01";
  ...
  const handlePushLead = async (leadId) => {
    try {
      ...
      const leadRef = doc(db, "dom-english-01", leadId);
  ...
  const handleDownloadExcel = () => {
    ...
    const filename = `dom-english-01-Leads-${new Date().toISOString().split("T")[0]}.xlsx`;
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Domestic English Leads</h1>
