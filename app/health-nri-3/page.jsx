...
export default function NRI1502() {
  ...
  useEffect(() => {
    const q = query(collection(db, "health-nri-3"), orderBy("submittedAt", "desc"));
  ...
  const handlePushLead = async (leadId) => {
    try {
      ...
      const leadRef = doc(db, "health-nri-3", leadId);
  ...
  const handleMarkAsJunk = async (leadId) => {
      try {
        ...
        await updateDoc(doc(db, "health-nri-3", leadId), {
          status: "junk",
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Health NRI 1503</h1>
