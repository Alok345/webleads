...
export default function NRI1502() {
  ...
  const handleDownloadExcel = () => {
    ...
    const filename = `dom-bangali-01-Leads-${
  ...
  const handleMarkAsJunk = async (leadId) => {
    try {
      ...
      await updateDoc(doc(db, "dom-bangali-01", leadId), {
        status: "junk",
