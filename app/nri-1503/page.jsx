...
export default function NRI1502() {
  ...
  const handleMarkAsJunk = async (leadId) => {
    try {
      ...
      await updateDoc(doc(db, "nri-1503", leadId), {
        status: "junk",
                            ...
                            <div className="flex gap-2">
                              ...
                              {lead.status === "pushed" && (
                                <button
                                  ...
                                  className="p-2 rounded-lg bg-yellow-100 text-yellow-700 hover:bg-yellow-200 transition-colors flex items-center gap-1"
